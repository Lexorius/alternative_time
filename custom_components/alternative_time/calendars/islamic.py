...
CALENDAR_INFO = {
    ...
    "documentation_url": "https://www.crescentmoonfoundation.org/islamic-calendar-basics",  # general explainer
...
class IslamicCalendarSensor(AlternativeTimeSensorBase):
    ...
    # ===============================
    # Update loop hook (called by base)
    # ===============================
    ...
    def set_options(self, *, show_arabic_names: bool | None = None, calculation_method: str | None = None, offset_days: int | None = None) -> None:
