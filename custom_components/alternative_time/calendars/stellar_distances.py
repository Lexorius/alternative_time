...
CALENDAR_INFO = {
    ...
    "star_notes": {
        ...
        "three_musketeers": {"en": "One of the 'Three Musketeers' middle-aged pulsars", "de": "Einer der 'Drei Musketiere' - mittelaltrige Pulsare", "es": "Uno de los púlsares de mediana edad 'Tres Mosqueteros'", "fr": "L'un des pulsars d'âge moyen 'Trois Mousquetaires'", "it": "Uno dei pulsar di mezza età 'Tre Moschettieri'", "nl": "Een van de 'Drie Musketiers' middelbare pulsars", "pl": "Jeden z pulsarów w średnim wieku 'Trzej Muszkieterowie'", "pt": "Um dos pulsares de meia-idade 'Três Mosqueteiros'", "ru": "Один из пульсаров среднего возраста 'Три мушкетёра'", "ja": "「三銃士」中年パルサーの一つ", "zh": ""三剑客"中年脉冲星之一", "ko": "'삼총사' 중년 펄서 중 하나"},
